...
class Logger:
    ...
    def __init__(
        ...
        self.model_saver_elements = None
    ...
    def nn_model_save(
        ...
        if is_flax:
            ...
            joblib.dump(pure_dict_state, fname)
        ...
        if is_torch:
            ...
            with warnings.catch_warnings():
                ...
                torch.save(nn_model_saver_element, fname)
            torch.save(nn_model_saver_element.state_dict(), fname)
    ...
    def nn_model_load(self, model, model_path, device, is_flax=True, is_torch=False):
        if is_torch:
            import torch
        ...
        if is_flax:
            ...
            restored_pure_dict = joblib.load(model_path)
