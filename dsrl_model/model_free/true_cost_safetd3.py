...
from dsrl_model.utils.models import BcqVAE, EnsembleValue, SafeDiceTanhMixtureActor
...
def main(args, cfg_env=None):
    ...
    logger.log("Start value and bc_policy training.")
    steps = 0
        ...
        for buffer_sample in buffer.sample():
            ...
            if (steps % config["log_freq"] == 0) and (not logger.logged):
                ...
                if args.use_eval:
                    ...
                    eval_cost_model = lambda *_: torch.tensor(0.0)
