...
source_path=/home/cs21d406/github/offline_mpc/dsrl_model/runs/neg_union/safetd3/norm/simultaneous_cost_contrastive/lr_0.00001/batch_128_M_0_hz_5/alpha_0.005_vbeta_0.001_bootlambda_0.0/
...
#for task in 'Ant' 'Swimmer' 'Walker2d' 'Circle2' 'Button1' 'Goal1'; do
    ...
    for ttype in 'ep_reward' 'ep_cost' 'ep_length' 'ep_worst_cost_0.1' 'ep_worst_cost_0.2' 'ep_worst_cost_0.3' 'ep_worst_cost_0.5'; do
       ...
       sshpass -p $pswd scp -r cs21d406@216.48.184.95:$source_path/*${task}*/*/seed-00*/${ttype}_*  $target_path/*${task}*/${ttype}/
